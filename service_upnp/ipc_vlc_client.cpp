				...
				int b_enabled, int b_loop )
{
	...
	return ipc_call_remote(p_instance, VLC_CMD_VLM_ADD_BROADCAST);
}
				...
				const char *psz_name, int b_enabled )
{
	...
	return ipc_call_remote(p_instance, VLC_CMD_VLM_SET_ENABLED);
}
				...
				const char *psz_name )
{
	...
	return ipc_call_remote(p_instance, VLC_CMD_VLM_PLAY_MEDIA);
}
				...
				const char *psz_name )
{
	...
	return ipc_call_remote(p_instance, VLC_CMD_VLM_DEL_MEDIA);
}
				...
				const char *psz_name )
{
	...
	return ipc_call_remote(p_instance, VLC_CMD_VLM_STOP_MEDIA);
}
...
{
	ipc_call_remote_np(p_instance, VLC_CMD_VLM_RELEASE);
}
