    ...
    , pCB(cb)
{
    ...
    char media_dir[256];
    agcmd_property_get(PropName_Media_dir, media_dir, "");
    snprintf(pTmpFile, 128, "%s/%s", media_dir, TMP_UPGRADE_FILENAME);
    snprintf(pFile, 128, "%s/%s", media_dir, UPGRADE_FILENAME);
}
