...
public:
    ...
    virtual bool GetWifiCltInfor(char* pName, int len);
    ...
    virtual void stopMark();
    virtual bool FactoryReset();
    virtual int getClientsNum();

#ifdef PLATFORMHACHI
    virtual void ScanNetworks();
    bool AddWifiNetwork(const char *json);
    virtual bool ConnectHost(char *ssid);
    virtual bool ForgetHost(char *ssid);
    ...
    virtual void enableAutoMark(bool enable);
    virtual void setSensitivity(gsensor_sensitive sens);
