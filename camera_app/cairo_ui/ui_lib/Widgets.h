...
public:
    ...
    void SetClickable(bool clickable) { _bClickable = clickable; }
...
public:
    ...
    void setScrollableSize(const Size& size);
...
public:
    ...
    void setItemPadding(UINT16 padding) { _padding = padding; }
