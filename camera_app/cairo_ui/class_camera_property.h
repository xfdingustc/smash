...
typedef enum camera_State
{
    ...
    camera_State_addwifi_result,
    camera_State_connectwifi_result,
    camera_State_Wifi_pwd_error,
...
public:
    ...
    virtual bool GetWifiCltInfor(char* pName, int len) = 0;
    ...
    virtual bool AddWifiNetwork(const char *json) = 0;
    virtual bool ConnectHost(char *ssid) = 0;
    virtual bool ForgetHost(char *ssid) = 0;
    ...
    virtual void enableAutoMark(bool enable) = 0;
    virtual void setSensitivity(gsensor_sensitive sens) = 0;
