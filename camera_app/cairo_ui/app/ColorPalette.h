...
#ifndef __Camera_ColorPalette_h_
#define __Camera_ColorPalette_h_
...
#define Color_Grey_2   0x6B6F   //  <- 0x686C7C

#define Color_Grey_3   0xA558   //  <- 0xA5ABC3

#define Color_Grey_4   0xA558   //  <- 0xa5abc3

#define Color_White    0xFFFF   //  <- 0xffffff

#define Color_Yellow_1 0xFFE3   //  <- 0xffff15

#define Color_Yellow_2 0xFE20   //  <- 0xffC701

#define Color_Red_1    0xE1C5   //  <- 0xe83828

#define Color_Red_2    0xFB68   // <- 0xff6e40

#define Color_Red_3    0x6801   // <- 0x690008
