...
void CThread::Go()
{
    if (!_bRuning) {
        ...
        if (0 == pthread_create(&_hThread, NULL, ThreadFunc, (void*)this)) {
            _bRuning = true;
        } else {
...
void* CThread::ThreadFunc(void* lpParam )
{
    ...
    if (thread != NULL) {
        ...
        ::prctl(PR_SET_NAME, thread->getName());
#endif
        thread->main();
    }
    return 0;
    ...
    , _count(0)
{
    ...
    //memset(_timerName, 0x00, sizeof(_timerName));
