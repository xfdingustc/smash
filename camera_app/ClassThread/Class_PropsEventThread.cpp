...
void CPropsEventThread::main()
{
    ...
    struct agcmd_property_wait_info_s *pwait_info_quality;
    ...
    pwait_info5 = agcmd_property_wait_start(storage_prop, StoragePropertyWaitCB);
    ...
    pwait_info_quality = agcmd_property_wait_start(PropName_rec_quality, ResolutionPropertyWaitCB);
    ...
    agcmd_property_wait_stop(pwait_info_quality);
